...
local spaceInDirection = dofile(hs.spoons.resourcePath("/ext/spaces.lua")).spaceInDirection
local isSpaceFullscreenApp = dofile(hs.spoons.resourcePath("/ext/spaces.lua")).isSpaceFullscreenApp
local focusScreen = dofile(hs.spoons.resourcePath("/ext/screen.lua")).focusScreen
